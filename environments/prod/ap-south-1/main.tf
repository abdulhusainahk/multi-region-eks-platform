...
# Secondary region. Mirrors us-east-1 topology with region-appropriate CIDRs.
# Shares the same Transit Gateway (RAM-shared from us-east-1).
###############################################################################
...
module "eks" {
  ...
  cluster_name       = "clevertap-prod-aps1"
  environment        = "prod"
  region             = var.region
  ...
  node_groups = {
    ...
    mixed-event-processing = {
      instance_types           = ["m6i.xlarge", "m6a.xlarge", "m5.xlarge", "m5a.xlarge", "m5d.xlarge"]
    ...
    spot-batch = {
      instance_types           = ["c6i.2xlarge", "c6a.2xlarge", "c5.2xlarge", "c5a.2xlarge"]
